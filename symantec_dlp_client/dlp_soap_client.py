...
if __name__ == "__main__":
    client = DLPSoapClient(app_configs={"sdlp_wsdl": "https://localhost:443/ProtectManager/services/v2011/incidents?wsdl",
                                            "sdlp_host": "https://localhost:443/",
                                            "sdlp_username": "admin",
                                            "sdlp_password": "admin"})
    print(client.incident_list(savedReportId=121,
                                incidentCreationDateLaterThan=datetime.datetime.now() - datetime.timedelta(days=30)))